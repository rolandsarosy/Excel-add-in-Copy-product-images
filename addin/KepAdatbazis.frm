VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} KepAdatbazis 
   Caption         =   "CORWELL webes  képleszedõ alkalmazás"
   ClientHeight    =   7185
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   6690
   OleObjectBlob   =   "KepAdatbazis.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "KepAdatbazis"
